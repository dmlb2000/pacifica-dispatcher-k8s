...
class DispatcherK8SErrorTest(celery_setup_test.TestDispatcherK8SBase, helper.CPWebCase):
    ...
    def test_error_script_path(self):
        ...
        self.assertTrue('This is an error string' in scriptlog.stderr,
                        'stderr did not contain \'This is an error string\'')
